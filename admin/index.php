        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ml-auto">
                    <a class="nav-link active pl-4" href="index.php">Yeni Soru</a>
...
<div id="mySidepanel" class="sidepanel">
  ...
  <a href="index.php?sinif=8">8. Sınıf</a>
    ...
    <main role="main">
        ...
        ?>
                        <div class="row">
                            <a href="index.php?sinif=<?php echo $_GET["sinif"] ?>&&testadi=<?php echo $row['adi'] ?>" class="btn btn-primary mt-4 w-50"><?php echo $row['adi'] ?></a>
